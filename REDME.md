...
The goal of this project is to demonstrate test automation fundamentals and demonstrate a clear, structured approach to testing a real-world web application.
...
BUG_NOTES.md    → Documented issues and observations
## Example Test Report

After running the tests, Playwright generates an HTML report that helps analyze test results and failures.

![Playwright Test Report](docs/report.png)